...
Participation is free and all are welcome: Academics, students, industry practitioners. We will send personalised (!) Zoom links for upcoming seminars by email. To participate, sign up to our mailing list (we won't send any spam not related to this seminar series).
...
<div id="mergeRow-gdpr" class="mergeRow gdpr-mergeRow content__gdprBlock mc-field-group">
    ...
    <div class="clear"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" style="font-size: 1.5em;"></div>
    </div>
...
<p>
<img src="/kings.JPG" alt="let me in..."/>
</p>
